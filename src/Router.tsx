...
import Square from './page/home/square';
import AddFriends from './page/mail/AddFriends';
import Loding from './components/Loding';

// const Square = lazy(() => import('./page/home/square'));
// const AddFriends = lazy(() => import('./page/mail/AddFriends/index'));
...
global.ErrorUtils.setGlobalHandler((error) => {
  ...
  console.log("js报错'", error.name, error.message);
  ...
  return (
    <NavigationContainer theme={DefaultTheme} ref={navigationRef}>
      <Stack.Navigator
        ...
        <Stack.Screen
          name={'Demo'}
          options={{title: 'Demo', header: undefined}}
          component={Demo}
        />
